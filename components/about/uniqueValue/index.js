  ...
  return (
    <div className="mb-12">
      <div className="container mx-auto pt-6 pb-8 text-3xl font-ubuntu text-dark text-center">
        <span className="font-light">Unique</span> <span className="font-medium">Value Proposition</span>
      </div>
      <div className="container mx-auto flex">
        {data.length > 0 && data.map((dataValue, index) => (
          <div
            key={index}
            className={classnames("font-ubuntu rounded shadow-grey-8 text-center mr-1 py-5 px-6", {
              "mr-1": index === 0,
              "ml-3 mr-3": index === 1,
              "ml-1": index === 2,
            })}>
